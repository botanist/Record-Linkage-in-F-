module RecordLinkage.JaroWinklerExtensions

open RecordLinkage.JaroWinkler
open RecordLinkage.StableMarriages

//
// From: http://richardminerich.com/2011/09/record-linkage-algorithms-in-f-extensions-to-jaro-winkler-distance-part-3/
//
...
let findBestAlignment = funGS scoreNamePairs
